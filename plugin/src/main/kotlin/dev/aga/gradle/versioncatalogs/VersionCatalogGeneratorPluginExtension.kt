...
@Inject
constructor(private val settings: Settings, val objects: ObjectFactory) {

  lateinit var config: GeneratorConfig

  /**
   * Generate a version catalog with the provided [name]. This is mostly used as an entry point for
   * the Gradle dsl
   *
   ...
   */
  fun generate(name: String, conf: Action<GeneratorConfig>): VersionCatalogBuilder {
